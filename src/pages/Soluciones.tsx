  ...
  return (
    <div>
      <div className="px-4 sm:px-6 pt-6">
        ...
        <div className="border-b border-ink/[.14] pb-6 mb-8 max-w-[680px]">
          ...
          <p className="text-[13.5px] text-ink/65 m-0">
            Cada proyecto empieza con un problema real. Elige la situación que más se parece a la tuya y te
            mostramos la solución técnica recomendada, con acceso directo al catálogo correspondiente.
          </p>
        </div>
      </div>

      <div className="px-4 sm:px-6 grid sm:grid-cols-2 gap-4 pb-10">
        {PROBLEMAS.map((p, i) => (
